...
// Native dashboard data access (used by onboarding wizard for tool detection)
...
function startNativeDataPolling(): void {
  // Polling removed — plugins connect directly to their servers via WebSocket
}
...
function setupIPC(): void {
  ...
  // Native dashboard IPC handlers removed — plugins connect directly to their servers
